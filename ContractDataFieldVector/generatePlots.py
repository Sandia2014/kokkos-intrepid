...
ompUncollapsedTimes = numpy.loadtxt(open(prefix + 'ompUncollapsedTimes' + suffix + '.csv','rb'),delimiter=',',skiprows=0)
...
allTimes.append(ompUncollapsedTimes)
allNames.append('ompUncollapsedTimes')
