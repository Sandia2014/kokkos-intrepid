...
struct contractFieldFieldScalarKokkosCudaMemFunctor {
	...
	contractFieldFieldScalarKokkosCudaMemFunctor(LeftViewType leftFields,
	...
	KOKKOS_INLINE_FUNCTION
		...
		int myCell = myID % _numCells;
		int matrixIndex = myID / _numCells;
