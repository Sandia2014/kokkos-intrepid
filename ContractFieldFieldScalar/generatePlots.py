...
kokkosCudaIndependentBestMemTimes = numpy.loadtxt(open(prefix +
'kokkosCudaIndependentBestMemTimes' + suffix + '.csv','rb'),delimiter=',',skiprows=0)
...
allTimes.append(kokkosCudaIndependentBestMemTimes)
allNames.append('kokkosCudaIndependentBestMem')
